...
import kotlinx.android.synthetic.main.item_servantdetail_levellist.view.*
import net.cachapa.expandablelayout.ExpandableLayout

class ServantDetailLevelListRecViewAdapter(val context: Context) : RecyclerView.Adapter<ServantDetailLevelListRecViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
            ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_servantdetail_levellist, parent, false)).apply {
                ...
                itemView.recView.apply {
                    adapter = ServantDetailItemListRecViewAdapter(context)
    ...
    override fun onBindViewHolder(holder: ViewHolder, pos: Int) {
        ...
        holder.itemView.apply {
            ...
            (recView.adapter as ServantDetailItemListRecViewAdapter).data = item.items
